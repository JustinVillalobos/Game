    ...
    <div class="body">
        ...
        <div class="row" style="margin-top:35px;">
            <div class="col-md-12 text-center text-white">
                ...
                <h3>El evento finalizó el día <?php echo $this->data["dateValid"];?></h3>
                <br>
                <span>Gracias por participar en el evento</span>
    ...
    <div class="footer">
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center" style="margin-top:20px;">
                <a href="PageController.php?action=ranking" class="btn btn-primary">Puntajes</a>
                
            </div>   
            <div class="col-md-12 d-flex justify-content-center" style="margin-top:20px;">
                <a href="PageController.php?action=index" class="btn btn-primary">Volver</a>
            </div>
    </div>
    </div>
</div>
